...
class Cool_Tag_Cloud_Widget extends WP_Widget {
	...
	public function form($p_instance) {
		...
		echo '<option ' . selected('ctcno_bg', $l_instance['imagestyle'], false) .
			' value="ctcno_bg">' . __('No Background', 'cool-tag-cloud') .'</option>';
		echo '</select>';
		echo '</p>';
	...
	public function update($p_new_instance, $p_old_instance) {
		...
		} else if ('ctcno_bg' == $p_new_instance['imagestyle']) {
			$l_instance['imagestyle'] = 'ctcno_bg';
		} else {
